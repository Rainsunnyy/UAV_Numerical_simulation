...
class DroneControl_feed_foward:
    ...
    def __init__(self):
        ...
        self.path = "/home/shuo/PythonProjects/UAV_Numerical_simulation/dataset/8_shape_NED.csv"
        self.path = "/home/parallels/PythonProjects/UAV_Numerical_simulation/dataset/8_shape_NED.csv"
    ...
    def forward_control(self,data): 
        self.forward_position_cmd = self.R_ENU2NED.as_matrix() @ np.array([data[1],data[2],data[3]])
        # print(self.forward_position_cmd)
        self.forward_velocity_cmd = self.R_ENU2NED.as_matrix() @ np.array([data[4],data[5],data[6]])
        ...
        self.forward_bodyrate_cmd = self.R_ENU2NED.as_matrix() @ np.array([data[15],data[16],data[17]])
        self.forward_attitude_cmd = self.R_ENU2NED.as_matrix() @ np.array(euler_from_quaternion([self.forward_orien_cmd[0],self.forward_orien_cmd[1],self.forward_orien_cmd[2],self.forward_orien_cmd[3]]))
...
if __name__ == "__main__":
    ...
    a = dronecontol_ff.set_forwardcontrol(0.3)
    print(a)
